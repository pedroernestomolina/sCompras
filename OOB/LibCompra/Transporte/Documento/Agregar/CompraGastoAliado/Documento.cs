...
namespace OOB.LibCompra.Transporte.Documento.Agregar.CompraGastoAliado
{
    public class Documento
    {
        ...
        public string SistDocRetIslrAuto { get; set; }
        public string SistDocRetIslrCodigo { get; set; }
        public string SistDocRetIslrNombre { get; set; }
        public int idPagoServAliado { get; set; }
    }
}