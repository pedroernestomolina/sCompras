...
namespace ModCompra.srcTransporte.CtaPagar.Tools.Administrador.Handler
{
    public class Imp: Vistas.IAdm
    {
        ...
        public string Get_TituloAdm { get { return "Administrador Documentos: PAGOS EMITIDOS"; } }
        ...
        public Imp()
        {
            ...
            _ctrFiltro = new srcTransporte.Filtro.CxpPagosEmitido.Imp();
        }
        ...
        public void Buscar()
        {
            if (_ctrFiltro.HndFiltro.VerificarFiltros())
            {
                ...
                if (r01 != null)
                {
                    ...
                    {
                        var nr = new dataItem((OOB.LibCompra.Transporte.CxpDoc.Pago.Lista.Ficha)rg);
                        lst.Add(nr);
                    }
        ...
        {
            srcTransporte.Reportes.IRepListAdm _rep = new srcTransporte.Reportes.ListaAdm.CxpPagosEmitidos.Imp();
            _rep.setFiltrosBusq("");
