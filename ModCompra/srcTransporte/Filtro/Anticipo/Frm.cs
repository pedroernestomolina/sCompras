...
namespace ModCompra.srcTransporte.Filtro.Anticipo
{
    public partial class Frm : Form
    {
        ...
        private void Frm_Load(object sender, EventArgs e)
        {
            ...
            CB_ALIADO.DataSource = _controlador.HndFiltro.Get_AliadoSource;
            TB_ALIADO.Text = _controlador.HndFiltro.GetAliado_TextoBuscar;
            CB_ESTATUS.SelectedValue = _controlador.HndFiltro.Get_EstatusById;
            CB_ALIADO.SelectedValue = _controlador.HndFiltro.Get_AliadoById;
        ...
        {
            _controlador.HndFiltro.setAliadoBuscar(TB_ALIADO.Text.Trim().ToUpper());
        }
        ...
        {
            if (_modoInicializar) { return; }
            _controlador.HndFiltro.setAliadoById("");
            if (CB_ALIADO.SelectedIndex != -1)
            {
                _controlador.HndFiltro.setAliadoById(CB_ALIADO.SelectedValue.ToString());
            }
        }
