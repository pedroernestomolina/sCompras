...
namespace ModCompra.srcTransporte.Beneficiario.Maestro
{
    public class Imp: Utils.Maestro.IMaestro
    {
        ...
        public string TituloMaestro_Get { get { return "Maestro: BENEFICIARIOS"; } }
        ...
        private void InsertarItemLista(int idItem)
        {
            try
            {
                var xr1 = Sistema.MyData.Transporte_Beneficiario_GetById(idItem);
                var obj = new OOB.LibCompra.Transporte.Beneficiario.Lista.Ficha(xr1.Entidad);
