...
namespace ModCompra.srcTransporte.Beneficiario.AdmMov.Handler
{
    public class Imp: Vistas.IAdm
    {
        ...
        public string Get_TituloAdm { get { return "Administrador Documentos: Beneficiarios"; } }
        ...
        public void Buscar()
        {
            if (_ctrFiltro.HndFiltro.VerificarFiltros())
            {
                ...
                if (r01 != null)
                {
                    ...
                    {
                        var nr = new dataItem((OOB.LibCompra.Transporte.Beneficiario.Mov.Lista.Ficha)rg);
                        lst.Add(nr);
                    }
