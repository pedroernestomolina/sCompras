...
namespace ModCompra.srcTransporte.Caja.Administrador.Handler
{
    public class Imp: Vistas.IAdm
    {
        ...
        public string Get_TituloAdm { get { return "Administrador Documentos: CAJA"; } }
        ...
        public Imp()
        {
            ...
            _ctrFiltro = new srcTransporte.Filtro.Caja.Imp();
        }
        ...
        public void Buscar()
        {
            if (_ctrFiltro.HndFiltro.VerificarFiltros())
            {
                ...
                if (r01 != null)
                {
                    ...
                    {
                        var nr = new dataItem((OOB.LibCompra.Transporte.Caja.Movimiento.Lista.Ficha)rg);
                        lst.Add(nr);
                    }
