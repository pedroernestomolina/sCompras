...
{
    public partial class FrmPanelEntidadDocPend: Form
    {
        private Interfaces.IZufuPanelEntidadDocPend _controlador;
        //
        ...
        public FrmPanelEntidadDocPend()
        {
            InitializeComponent();
            InicializaGrid();
        }
        public void setControlador(Interfaces.IZufuPanelEntidadDocPend ctr)
        {
            _controlador = ctr;
        }
        private bool _modoInicializar;

        private void FrmPanelDocPend_Load(object sender, EventArgs e)
        {
        ...
        private void FrmPanelDocPend_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
        ...
        {
            L_ENTIDAD_DATA.Text = _controlador.GetEntidadData;
