...
namespace DataProvCompra.InfraEstructura
{
    ...
    public interface IReportes
    {
        ...
        OOB.ResultadoLista<OOB.LibCompra.Reportes.GeneralDocumentos.Ficha> 
            Reportes_ComprasDocumento(OOB.LibCompra.Reportes.GeneralDocumentos.Filtro filtro);
        OOB.ResultadoLista<OOB.LibCompra.Reportes.CompraporDepartamento.Ficha> 
            Reportes_ComprasPorDepartamento(OOB.LibCompra.Reportes.CompraporDepartamento.Filtro filtro);
        OOB.ResultadoLista<OOB.LibCompra.Reportes.CompraporProducto.Ficha> 
