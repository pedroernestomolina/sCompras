...
namespace ServiceCompra.MyService
{
    ...
    public partial class Service: IService
    {
        ...
        {
            return ServiceProv.Permiso_RegistrarFactura_ProcesarDocumento(autoGrupoUsuario);
        }
        public DtoLib.ResultadoEntidad<DtoLibCompra.Permiso.Ficha> 
            Permiso_RegistrarFactura_CambiarPrecioVenta(string autoGrupoUsuario)
        {
            return ServiceProv.Permiso_RegistrarFactura_CambiarPrecioVenta(autoGrupoUsuario);
        }
        public DtoLib.ResultadoEntidad<DtoLibCompra.Permiso.Ficha> 
            Permiso_ConfiguracionSistema(string autoGrupoUsuario)
        {
            return ServiceProv.Permiso_ConfiguracionSistema(autoGrupoUsuario);
        }
