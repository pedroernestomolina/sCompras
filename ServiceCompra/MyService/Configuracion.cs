...
namespace ServiceCompra.MyService
{
    ...
    public partial class Service: IService
    {
        ...
        {
            return ServiceProv.Configuracion_GetPermitirCambiarPrecioAlRegistrarDocCompra();
        }
        public DtoLib.Resultado 
            Configuracion_SetPermitirCambiarPrecioAlRegistrarDocCompra(string cnf)
        {
            return ServiceProv.Configuracion_SetPermitirCambiarPrecioAlRegistrarDocCompra(cnf);
        }
